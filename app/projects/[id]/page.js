...
import { FileText, Upload, X, Archive, RotateCcw, AlertTriangle, Plus, Info } from 'lucide-react'
  ...
  return (
    <>
      ...
      <div className="mb-6">
          ...
          <div className="flex gap-3">
            ...
            {project.status === 'archived' ? (
              <div className="flex items-center gap-2">
                ...
                <HelpIcon
                  ...
                  content="Restore this archived project to active status."
                  bullets={[
                    "Makes project editable again",
                    "Restores all sections and observations",
                    "Project appears in main project list"
                  ]}
                  size="sm"
                />
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <HelpIcon
                  ...
                  content="Move completed or inactive projects to archive."
                  bullets={[
                    "Removes from main project list",
                    "Preserves all data and observations",
                    "Can be restored anytime",
                    "Useful for completed inspections"
                  ]}
                  size="sm"
                />
              </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <HelpIcon
                ...
                content="Upload multiple videos at once to your project pool."
                bullets={[
                  "Upload up to 10 videos simultaneously",
                  "Videos go to pool for later assignment",
                  "Each video upload costs credits",
                  "MP4, H.264 formats preferred, other formats will be converted",
                  "Stored for 90 days",
            ...
            <div className="flex items-center gap-2">
              ...
              <HelpIcon
                ...
                content="Generate and manage inspection reports."
                bullets={[
                  "Create Web Reports",
                  "Share via public links",
                  "Include observations and images",
            ...
            <div className="flex items-center gap-2">
              ...
              <HelpIcon
                title="Add Section"
                content="Create a new section for your inspection."
                bullets={[
                  "Each section represents a pipe segment or run",
                  "Name sections clearly (e.g., 'MH1 to MH2')",
                  "Add location and pipe details",
                  "Upload or select video from pool",
                  "Non standard videos are converted to MP4, H.264",
        ...
        {/* Sections Grid with Help */}
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-4">
            <h3 className="text-lg font-medium text-gray-900">Sections</h3>
            <HelpIcon
              title="Project Sections"
              content="Organize your inspection into logical sections."
              bullets={[
                "Each section typically represents one pipe run",
                "Click a section to view its video and observations",
                "Upload videos directly or select from pool",
                "Non standard videos are converted to MP4, H.264",
                "Colour coded badges show observation count",
                "Red badges indicate high-severity issues"
              ]}
              size="sm"
            />
          </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <HelpIcon
            ...
            content="Adjust the workspace layout to suit your workflow."
            bullets={[
              "Video Only: Full screen video player",
              "Data Only: Focus on observations",
              "Split View: Video and data side-by-side",
              "Map View: Infrastructure mapping",
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <HelpIcon
                    ...
                    bullets={[
                      ...
                      "Capture frames for observations",
                      "Mouse wheel: Scrub through video"
                    ]}
                    size="sm"
                  />
                </div>
              ...
              <div className="flex items-center justify-between p-4 border-b border-gray-200 bg-gray-50">
                <div className="flex items-center space-x-2">
                  ...
                  <HelpIcon
                    ...
                    bullets={[
                      "Add observations with timestamp",
                      "Attach images as evidence (1 credit)",
                      "Select severity levels",
                      "AI analysis available (5 credits)",
                      "Click time stamp to jump to video"
                    ]}
                    size="sm"
                  />
                </div>
